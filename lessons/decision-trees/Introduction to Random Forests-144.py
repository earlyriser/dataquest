...
pred2 = clf2.predict(test[columns])

auc = roc_auc_score(test["high_income"], pred)
auc2 = roc_auc_score(test["high_income"], pred2)
...
val = numpy.round( (predictions + predictions2)/2)

print(roc_auc_score(test["high_income"], val))
