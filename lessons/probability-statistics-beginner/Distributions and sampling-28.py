...
income.sort_values(['median_income'], ascending=[True], inplace=True)
...
large_mean = numpy.mean(large_sample)
deviations_from_mean = (0.18-large_mean) / large_sample_std

over_18_count = 0

for elem in large_sample:
    if elem >= 0.18:
        over_18_count +=1
