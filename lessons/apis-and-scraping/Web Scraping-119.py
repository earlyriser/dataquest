...
inner_ps = parser.find_all("p", class_="inner-text")
outer_ps = parser.find_all("p", class_="outer-text")
first_inner_paragraph = inner_ps[0]
print(first_inner_paragraph.text)

second_inner_paragraph_text = inner_ps[1].text
first_outer_paragraph_text = outer_ps[0].text
