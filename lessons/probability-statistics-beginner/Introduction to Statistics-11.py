...
plt.hist(student_scores, range(0,100))
plt.show()
...
#mean
age_mean = new_titanic_survival["age"].mean()
plt.axvline(age_mean, color="r")

#median
age_median = numpy.median(new_titanic_survival["age"])
plt.axvline(age_median, color="g")
