...
/home/dq/random_numbers$ git config --global user.name "Roberto"

## 6. Committing Changes ##

/home/dq/random_numbers$ git commit -m "Initial commit. Added sc
...
/home/dq/random_numbers$ git commit -m "random method"
